...
class MedicalPatientDisease(models.Model):
    ...
    pathology_id = fields.Char('Disease', required=True)
    ...
    status = fields.Selection([('c', 'Chronic'), ('s', 'Status quo'), ('h', 'Healed'), ('i', 'Improving'),
    ...
    patient_id = fields.Many2one('abc_hms.patient',string="Patient")
